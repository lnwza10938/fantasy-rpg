...
export class Skill {
  ...
  public get trigger(): SkillTrigger {
    return this.getDigit(0) as SkillTrigger;
  }
  public get role(): SkillRole {
    return this.getDigit(1) as SkillRole;
  }
  public get target(): TargetType {
    return this.getDigit(2) as TargetType;
  }
  public get effect(): EffectType {
    return this.getDigit(3) as EffectType;
  }
  public get scaling(): ScalingSource {
    return this.getDigit(4) as ScalingSource;
  }
  public get delivery(): DeliveryShape {
    return this.getDigit(5) as DeliveryShape;
  }
  public get duration(): SkillDuration {
    return this.getDigit(6) as SkillDuration;
  }
  public get modifier(): SecondaryModifier {
    return this.getDigit(7) as SecondaryModifier;
  }
  public get special(): SpecialProperty {
    return this.getDigit(8) as SpecialProperty;
  }
}
