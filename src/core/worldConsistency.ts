...
export type Biome = 'volcanic' | 'tundra' | 'forest' | 'desert' | 'swamp' | 'mountain' | 'coast' | 'void';
...
const BIOME_RULES: Record<Biome, BiomeRule> = {
    volcanic: { allowed: ['Fire Imp', 'Stone Golem', 'Shadow Fiend'], forbidden: ['Frost Wraith', 'Wolf'], temperature: 'hot' },
    tundra: { allowed: ['Frost Wraith', 'Wolf', 'Skeleton'], forbidden: ['Fire Imp', 'Slime'], temperature: 'cold' },
    forest: { allowed: ['Goblin', 'Wolf', 'Orc', 'Slime'], forbidden: [], temperature: 'temperate' },
    desert: { allowed: ['Skeleton', 'Stone Golem', 'Slime'], forbidden: ['Frost Wraith', 'Wolf'], temperature: 'hot' },
    swamp: { allowed: ['Slime', 'Goblin', 'Shadow Fiend'], forbidden: ['Stone Golem'], temperature: 'temperate' },
    mountain: { allowed: ['Orc', 'Dark Knight', 'Stone Golem'], forbidden: ['Slime'], temperature: 'cold' },
    coast: { allowed: ['Goblin', 'Fire Imp', 'Wolf'], forbidden: [], temperature: 'temperate' },
    void: { allowed: ['Shadow Fiend', 'Dark Knight', 'Frost Wraith'], forbidden: ['Goblin', 'Slime'], temperature: 'cold' },
};

// Map region names to biomes
const REGION_BIOMES: Record<string, Biome> = {
    'Ash Valley': 'volcanic', 'Crystal Cavern': 'mountain', 'Shadow Forest': 'forest',
    'Iron Peaks': 'mountain', 'Moonlit Marsh': 'swamp', 'Infernal Rift': 'volcanic',
    'Frozen Tundra': 'tundra', 'Golden Desert': 'desert', 'Crimson Coast': 'coast', 'Void Abyss': 'void',
};
