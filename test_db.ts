import { createPlayer, createCharacter, getCharacter, saveCombatLog } from './src/db/repositories.js';
...
async function runFullIntegrationTest() {
    ...
    try {
        ...
        const result = await combatSystem.executeFullCombat(effHero, effGoblin, battleId);
        console.log("✅ Combat Finished. Winner:", result.winnerId === heroStats.id ? "Hero" : "Goblin");
